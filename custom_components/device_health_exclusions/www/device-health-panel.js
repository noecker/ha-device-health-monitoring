 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:$e}=re,be=()=>document.createComment(""),me=(e,t,i)=>{const s=e._$AA.parentNode,r=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(be(),r),o=s.insertBefore(be(),r);i=new $e(t,o,e,e.options)}else{const t=i._$AB.nextSibling,o=i._$AM,n=o!==e;if(n){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==o._$AU&&i._$AP(t)}if(t!==r||n){let e=i._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,r),e=t}}}return i},Ae=(e,t,i=e)=>(e._$AI(t,i),e),we={},Ee=e=>{e._$AR(),e._$AA.remove()},Se=(e,t,i)=>{const s=new Map;for(let r=t;r<=i;r++)s.set(e[r],r);return s},ke=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends fe{constructor(e){if(super(e),e.type!==ye)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const r=[],o=[];let n=0;for(const t of e)r[n]=s?s(t,n):n,o[n]=i(t,n),n++;return{values:o,keys:r}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const r=(e=>e._$AH)(e),{values:o,keys:n}=this.dt(t,i,s);if(!Array.isArray(r))return this.ut=n,o;const a=this.ut??=[],d=[];let c,l,h=0,p=r.length-1,u=0,g=o.length-1;for(;h<=p&&u<=g;)if(null===r[h])h++;else if(null===r[p])p--;else if(a[h]===n[u])d[u]=Ae(r[h],o[u]),h++,u++;else if(a[p]===n[g])d[g]=Ae(r[p],o[g]),p--,g--;else if(a[h]===n[g])d[g]=Ae(r[h],o[g]),me(e,d[g+1],r[h]),h++,g--;else if(a[p]===n[u])d[u]=Ae(r[p],o[u]),me(e,r[h],r[p]),p--,u++;else if(void 0===c&&(c=Se(n,u,g),l=Se(a,h,p)),c.has(a[h]))if(c.has(a[p])){const t=l.get(n[u]),i=void 0!==t?r[t]:null;if(null===i){const t=me(e,r[h]);Ae(t,o[u]),d[u]=t}else d[u]=Ae(i,o[u]),me(e,r[h],i),r[t]=null;u++}else Ee(r[p]),p--;else Ee(r[h]),h++;for(;u<=g;){const t=me(e,d[g+1]);Ae(t,o[u]),d[u++]=t}for(;h<=p;){const e=r[h++];null!==e&&Ee(e)}return this.ut=n,((e,t=we)=>{e._$AH=t})(e,d),Q}});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Ce=class extends ae{constructor(){super(...arguments),this.devices=[],this.filterMode="all",this.searchQuery="",this._expandedIntegrations=new Set,this._expandedDevices=new Set}connectedCallback(){super.connectedCallback(),this._expandAllGroups()}updated(e){e.has("devices")&&this._expandAllGroups()}_expandAllGroups(){const e=this._getGroupedDevices();this._expandedIntegrations=new Set(e.map(e=>e.integration)),this._expandedDevices=new Set(e.flatMap(e=>e.devices.map(t=>t.device_id||`standalone-${e.integration}`)))}render(){const e=this._getGroupedDevices();return 0===e.length?L`
